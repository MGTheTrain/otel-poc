...
echo -e "helm lint infra/helm-charts/services/python-otel-service/"
echo ""
echo -e "${YELLOW}# Template chart:${NC}"
echo -e "helm template infra/helm-charts/services/python-otel-service/"
echo ""
echo -e "${YELLOW}# Check dependencies:${NC}"
echo -e "helm dependency update infra/helm-charts/services/python-otel-service/"
echo ""
